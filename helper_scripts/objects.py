...
<head>
  ...
  <title>Parsa Ghadermazi - Bioinformatics Researcher</title>
...
<body>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
          integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5c5p5p5p5p5p5p5p5"
    ...
    def make_html_from_json(self, json_input, outpath):
        ...
        for post in data:
            html_text += (
                ...
                .replace("<TEXT>", post["body"])
                .replace("<IMGLOC>", post["image"])
                .replace("<IMG_ALT_TEXT>", post["alt_text"])
            )

        html_text += self.footer
